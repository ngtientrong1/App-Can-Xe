...
public sealed class Phase8Rc2AdminDialogLayoutTests
{
    ...
    public void Desktop_Version_Is_1_0_2()
    {
        ...
        Assert.Contains("<Version>1.0.5</Version>", csproj, StringComparison.Ordinal);
        Assert.Contains("<InformationalVersion>1.0.5</InformationalVersion>", csproj, StringComparison.Ordinal);
    }
