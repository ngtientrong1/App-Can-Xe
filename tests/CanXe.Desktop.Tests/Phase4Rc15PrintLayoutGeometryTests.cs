...
[Collection("WpfSta")]
public sealed class Phase4Rc15PrintLayoutGeometryTests
{
    private readonly WpfSmokeFixture _fixture;

    public Phase4Rc15PrintLayoutGeometryTests(WpfSmokeFixture fixture) => _fixture = fixture;

    [Fact]
    public void CopyLayout_HasNoOuterFrameAndNoIntersections()
    {
        _fixture.Invoke(_ =>
        {
    ...
    [Fact]
    public void IdentityCards_Are19MillimetersTall()
    {
        _fixture.Invoke(_ =>
        {
            var copy = WpfWeighTicketDocumentFactory.CreateMaterializedCopy(BuildSampleModel());
